...
function custom_theme_options() {
  ...
  $custom_settings = array( 
    ...
    'sections'        => array( 
       array(
        'id'          => 'Headerpart',
        'title'       => __( 'Header Part', 'theme-text-domain' )
      ),
     array(
        'id'          => 'HomePagePart',
        'title'       => __( 'Home Page Part', 'theme-text-domain' )
      ),
     array(
        'id'          => 'ShopPart',
        'title'       => __( 'Shop Page', 'theme-text-domain' )
      ),
     array(
        'id'          => 'ContactPart',
        'title'       => __( 'Contact Part', 'theme-text-domain' )
      ),
    array(
        'id'          => 'FooterPart',
    ...
    array(
        'id'          => 'b404b',
        'title'       => __( '404 Page', 'theme-text-domain' )
      ),
 ...
 array(
        'id'          => 'hcontactnumbr',
        'label'       => __( 'Header Top Phone Number', 'theme-text-domain' ),
        'desc'        => __( 'Give the header top contact phone number', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'Headerpart',
        'rows'        => '',
  ...
  array(
        'id'          => 'hemail',
        'label'       => __( 'Header Top Email ', 'theme-text-domain' ),
        'desc'        => __( 'Give the header top contact email', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'Headerpart',
        'rows'        => '',
  ...
  array(
        'id'          => 'hsociallinks',
        'label'       => __( 'Social links for the header top', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'social-links',
        'section'     => 'Headerpart',
        'rows'        => '',
  ...
  array(
        'id'          => 'hlogoimg',
        'label'       => __( 'Give the header logo image(150x60)', 'theme-text-domain' ),
        'desc'        => __( 'Give the header logo image or below the header logo txt', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'Headerpart',
        'rows'        => '',
   ...
   array(
        'id'          => 'hlogotxt',
        'label'       => __( 'Give the header logo txt)', 'theme-text-domain' ),
        'desc'        => __( 'Give the header logo txt or above the header logo image', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'Headerpart',
        'rows'        => '',
       ...
       array(
        'id'          => 'homepagesidebarfirst',
        'label'       => __( 'Side Offer Image-1(size 265x350)', 'theme-text-domain' ),
        'desc'        => __( 'Give The Sidebar First Image', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'HomePagePart',
        'rows'        => '',
        'post_type'   => '',
        'taxonomy'    => '',
        'min_max_step'=> '',
        ...
        array(
        'id'          => 'homepagesidebarsecond',
        'label'       => __( 'Side Offer Image-2 (size 265x350)', 'theme-text-domain' ),
        'desc'        => __( 'Give The Sidebar Second Image', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'HomePagePart',
        'rows'        => '',
        ...
        array(
        'id'          => 'homepagesidebarthird',
        'label'       => __( 'Side Offer Image-3 (size 265x350)', 'theme-text-domain' ),
        'desc'        => __( 'Give The Sidebar Third Image', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'HomePagePart',
        'rows'        => '',
        ...
        'operator'    => 'and'
         ...
         array(
        'id'          => 'ftopcompinfot1',
        'label'       => __( 'Footer Top Company Info Title First Letter', 'theme-text-domain' ),
        'desc'        => __( 'Give The Footer Top Company Info First Letter', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'FooterPart',
        'rows'        => '',
        ...
        'operator'    => 'and'
          ...
          array(
        'id'          => 'ftopcompinfot2',
        'label'       => __( 'Footer Top Company Info Title Remaining Part', 'theme-text-domain' ),
        'desc'        => __( 'Give The Footer Top Company Info Remaining Part', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'FooterPart',
        'rows'        => '',
        ...
        'operator'    => 'and'
           ...
           array(
        'id'          => 'ftopcompinfodesc',
        'label'       => __( 'Footer Top Company Info Description', 'theme-text-domain' ),
        'desc'        => __( 'Give The Footer Top Company Info Description', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'FooterPart',
        'rows'        => '',
        ...
        array(
        'id'          => 'gimg1',
        'label'       => __( 'Footer top gallery image-1 (size 130x60)', 'theme-text-domain' ),
        'desc'        => __( 'Give The Footer Top Gallery First Image', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'FooterPart',
        'rows'        => '',
        ...
        'operator'    => 'and'
         ...
         array(
        'id'          => 'gimgdesc1',
        'label'       => __( 'Footer top gallery image-1 Description', 'theme-text-domain' ),
        'desc'        => __( 'Give The Footer Top Gallery First Image Description', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'FooterPart',
        'rows'        => '',
        ...
        'operator'    => 'and'
          ...
          array(
        'id'          => 'gimgdate1',
        'label'       => __( 'Footer top gallery image-1 date', 'theme-text-domain' ),
        'desc'        => __( 'Give The Footer Top Gallery First Image Date', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'FooterPart',
        'rows'        => '',
        ...
        array(
        'id'          => 'gimg2',
        'label'       => __( 'Footer top gallery image-2 (size 130x60)', 'theme-text-domain' ),
        'desc'        => __( 'Give The Footer Top Gallery Second Image', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'FooterPart',
        'rows'        => '',
        ...
        'operator'    => 'and'
         ...
         array(
        'id'          => 'gimgdesc2',
        'label'       => __( 'Footer top gallery image-2 Description', 'theme-text-domain' ),
        'desc'        => __( 'Give The Footer Top Gallery Second Image Description', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'FooterPart',
        'rows'        => '',
        ...
        'operator'    => 'and'
          ...
          array(
        'id'          => 'gimgdate2',
        'label'       => __( 'Footer top gallery image-2 date', 'theme-text-domain' ),
        'desc'        => __( 'Give The Footer Top Gallery Second Image Date', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'FooterPart',
        'rows'        => '',
        ...
        array(
        'id'          => 'gimg3',
        'label'       => __( 'Footer top gallery image-3 (size 130x60)', 'theme-text-domain' ),
        'desc'        => __( 'Give The Footer Top Gallery Third Image', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'FooterPart',
        'rows'        => '',
        ...
        'operator'    => 'and'
         ...
         array(
        'id'          => 'gimgdesc3',
        'label'       => __( 'Footer top gallery image-3 Description', 'theme-text-domain' ),
        'desc'        => __( 'Give The Footer Top Gallery Third Image Description', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'FooterPart',
        'rows'        => '',
        ...
        'operator'    => 'and'
          ...
          array(
        'id'          => 'gimgdate3',
        'label'       => __( 'Footer top gallery image-3 date', 'theme-text-domain' ),
        'desc'        => __( 'Give The Footer Top Gallery Third Image Date', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'FooterPart',
        'rows'        => '',
        ...
        array(
        'id'          => 'gimg4',
        'label'       => __( 'Footer top gallery image-4 (size 130x60)', 'theme-text-domain' ),
        'desc'        => __( 'Give The Footer Top Gallery Forth Image', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'FooterPart',
        'rows'        => '',
        ...
        'operator'    => 'and'
         ...
         array(
        'id'          => 'gimgdesc4',
        'label'       => __( 'Footer top gallery image-4 Description', 'theme-text-domain' ),
        'desc'        => __( 'Give The Footer Top Gallery Forth Image Description', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'FooterPart',
        'rows'        => '',
        ...
        'operator'    => 'and'
          ...
          array(
        'id'          => 'gimgdate4',
        'label'       => __( 'Footer top gallery image-4 date', 'theme-text-domain' ),
        'desc'        => __( 'Give The Footer Top Gallery Forth Image Date', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'FooterPart',
        'rows'        => '',
        ...
        array(
        'id'          => 'ftadderssimg',
        'label'       => __( 'Footer top address img (size between 290x160)', 'theme-text-domain' ),
        'desc'        => __( 'Give The Footer Top Address image', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'FooterPart',
        'rows'        => '',
        ...
        'operator'    => 'and'
         ...
         array(
        'id'          => 'ftadderssimgdesc',
        'label'       => __( 'Footer top address img Description', 'theme-text-domain' ),
        'desc'        => __( 'Give The Footer Top Address image Description', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'FooterPart',
        'rows'        => '',
      ...
      array(
        'id'          => 'fcopywrite',
        'label'       => __( 'Footer CopyWrite', 'theme-text-domain' ),
        'desc'        => __( 'Give The Footer CopyWrite', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'FooterPart',
        'rows'        => '',
      ...
      array(
        'id'          => 'maps',
        'label'       => __( 'Map Url', 'theme-text-domain' ),
        'desc'        => __( 'Give The Maps Embed Code', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'ContactPart',
        'rows'        => '',
       ...
       array(
        'id'          => 'conformtitle',
        'label'       => __( 'Contact Form Title', 'theme-text-domain' ),
        'desc'        => __( 'Give The Contact Form Title', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'ContactPart',
        'rows'        => '',
       ...
       array(
        'id'          => 'socialbooktitle',
        'label'       => __( 'Contact Social Bookmarks Title', 'theme-text-domain' ),
        'desc'        => __( 'Give The Social Title ', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'ContactPart',
        'rows'        => '',
        ...
        array(
        'id'          => 'socialbook',
        'label'       => __( 'Contact Social Bookmarks', 'theme-text-domain' ),
        'desc'        => __( 'Give The Social link ', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'social-links',
        'section'     => 'ContactPart',
        'rows'        => '',
        ...
        array(
        'id'          => 'shopoffer',
        'label'       => __( 'Shop Page Offer Image(size 1170x150)', 'theme-text-domain' ),
        'desc'        => __( 'Give The Shop Page Offer Image ', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'ShopPart',
        'rows'        => '',
        ...
        array(
        'id'          => '404logo',
        'label'       => __( '404 Logo', 'theme-text-domain' ),
        'desc'        => __( 'Give The 404 Logo', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'b404b',
        'rows'        => '',
        ...
        'operator'    => 'and'
         ...
         array(
        'id'          => '404mainimage',
        'label'       => __( '404 Main Image', 'theme-text-domain' ),
        'desc'        => __( 'Give The 404 Main Image', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'b404b',
        'rows'        => '',
        ...
        array(
        'id'          => '404h11',
        'label'       => __( '404 H1 Heading part 1', 'theme-text-domain' ),
        'desc'        => __( 'Give The 404 H1 Heading Part One', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'b404b',
        'rows'        => '',
        ...
        'operator'    => 'and'
         ...
         array(
        'id'          => '404h12',
        'label'       => __( '404 H1 Heading part 2', 'theme-text-domain' ),
        'desc'        => __( 'Give The 404 H1 Heading Part Two', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'b404b',
        'rows'        => '',
        ...
        array(
        'id'          => '404desc',
        'label'       => __( '404 Paragraph', 'theme-text-domain' ),
        'desc'        => __( 'Give The Description text', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'textarea',
        'section'     => 'b404b',
        'rows'        => '',
        ...
        array(
        'id'          => '404h2',
        'label'       => __( '404 H2 Part', 'theme-text-domain' ),
        'desc'        => __( 'Give The 404 Heading Two Part', 'theme-text-domain' ),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'b404b',
        'rows'        => '',
